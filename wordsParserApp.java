...
public class wordsParserApp {
    ...
    public static void main(String[] args) {
        ...
        // ==========================
        if (args.length == 0) {
            System.out.println("Uso: java wordsParserApp <ficheiro.words>");
            return;
        }
        ...
        try {
            ...
            wordsLexer lexer = new wordsLexer(charStream);
            CommonTokenStream tokens = new CommonTokenStream(lexer);

            wordsParser parser = new wordsParser(tokens);
            ...
            for (Token token : tokens.getTokens()) {
                String name = wordsLexer.VOCABULARY.getSymbolicName(token.getType());
